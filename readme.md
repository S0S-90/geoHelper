...
#Voraussetzungen
* Python 2.7 mit Modulen: sys, glob, os, time, datetime, xml.etree.ElementTree, webbrowser (alle in Standardbibliothek vorhanden)
...
* Download und Entpacken des Archivs "geoHelper_v1.0.1-beta.zip" auf [Release Page](https://github.com/S0S-90/geoHelper/releases) 
